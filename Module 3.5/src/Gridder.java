...
public class Gridder extends javax.swing.JFrame
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int k = (int)(Math.random() * gridCount);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        for (int i = 0; i < gridCount; i++) {
            ...
            for (int k = 0; k < gridCount; k++) {
                ...
                if (i > 0 && k < gridCount - 1 && grid[i - 1][k + 1] == 1) {

                    j++;

                }

                if (k < gridCount - 1 && grid[i][k + 1] == 1) {

                    j++;

                }

                if (i < gridCount - 1 && k < gridCount - 1 && grid[i + 1][k + 1] == 1) {

                    j++;

                }

                if (i < gridCount - 1 && grid[i + 1][k] == 1) {

                    j++;

                }

                if (i < gridCount - 1 && k > 0 && grid[i + 1][k - 1] == 1) {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        for (int i = 0; i < gridCount; i++) {
            ...
            for (int k = 0; k < gridCount; k++) {
                ...
                if (grid[k][gridCount - 1 - i] == 0) continue;

                temp[i][k] = grid[k][gridCount - 1 - i];
